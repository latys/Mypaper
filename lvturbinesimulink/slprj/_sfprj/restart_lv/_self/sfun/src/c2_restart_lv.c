...
#include "restart_lv_sfun.h"
#include "c2_restart_lv.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance.chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance.instanceNumber)
#include "restart_lv_sfun_debug_macros.h"
...
static SFc2_restart_lvInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_restart_lv(void);
static void initialize_params_c2_restart_lv(void);
static void enable_c2_restart_lv(void);
static void disable_c2_restart_lv(void);
static void finalize_c2_restart_lv(void);
static void sf_c2_restart_lv(void);
...
static void initialize_c2_restart_lv(void)
{
  ...
  chartInstance.c2_is_active_c2_restart_lv = 0U;
}
...
static void sf_c2_restart_lv(void)
{
  ...
  *c2_b_Te = c2_Te;
  ...
  sf_debug_check_for_state_inconsistency(_restart_lvMachineNumber_,
...
const mxArray *sf_c2_restart_lv_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[42])
{
  ...
  c2_info[1].resolved = "[B]eq";
  c2_info[1].fileLength = 0U;
  c2_info[1].fileTime1 = 0U;
  c2_info[1].fileTime2 = 0U;
  c2_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[2].name = "eml_assert_valid_size_arg";
  c2_info[2].dominantType = "double";
  c2_info[2].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[2].fileLength = 1360U;
  c2_info[2].fileTime1 = 1192445166U;
  ...
  c2_info[4].name = "ndims";
  c2_info[4].dominantType = "double";
  c2_info[4].resolved = "[B]ndims";
  ...
  c2_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c2_info[7].name = "logical";
  c2_info[7].dominantType = "double";
  c2_info[7].resolved = "[B]logical";
  ...
  c2_info[8].fileTime1 = 1192445120U;
  c2_info[8].fileTime2 = 0U;
  c2_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[9].name = "eml_alloc";
  c2_info[9].dominantType = "double";
  c2_info[9].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[9].fileLength = 2558U;
  c2_info[9].fileTime1 = 1197275544U;
  ...
  c2_info[10].fileLength = 376U;
  c2_info[10].fileTime1 = 1192445204U;
  ...
  c2_info[11].fileLength = 866U;
  c2_info[11].fileTime1 = 1192445044U;
  ...
  c2_info[15].fileLength = 628U;
  c2_info[15].fileTime1 = 1192445322U;
  c2_info[15].fileTime2 = 0U;
  c2_info[16].context = "";
  c2_info[16].name = "mtimes";
  c2_info[16].dominantType = "double";
  c2_info[16].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[16].fileLength = 1990U;
  c2_info[16].fileTime1 = 1197627150U;
  ...
  c2_info[19].fileTime1 = 1192445318U;
  ...
  c2_info[26].fileTime1 = 1192445206U;
  ...
  c2_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[28].name = "not";
  ...
  c2_info[29].name = "isreal";
  c2_info[29].dominantType = "double";
  c2_info[29].resolved = "[B]isreal";
  ...
  c2_info[30].name = "nargin";
  c2_info[30].dominantType = "";
  c2_info[30].resolved = "[B]nargin";
  c2_info[30].fileLength = 0U;
  c2_info[30].fileTime1 = 0U;
  c2_info[30].fileTime2 = 0U;
  c2_info[31].context = "";
  c2_info[31].name = "mrdivide";
  c2_info[31].dominantType = "double";
  c2_info[31].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[31].fileLength = 638U;
  c2_info[31].fileTime1 = 1197275550U;
  c2_info[31].fileTime2 = 0U;
  c2_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[32].name = "eml_error";
  c2_info[32].dominantType = "char";
  c2_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c2_info[32].fileLength = 318U;
  c2_info[32].fileTime1 = 1192445176U;
  c2_info[32].fileTime2 = 0U;
  c2_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[33].name = "eml_warning";
  c2_info[33].dominantType = "char";
  c2_info[33].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c2_info[33].fileLength = 265U;
  c2_info[33].fileTime1 = 1192445214U;
  c2_info[33].fileTime2 = 0U;
  c2_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[34].name = "ge";
  c2_info[34].dominantType = "double";
  c2_info[34].resolved = "[B]ge";
  c2_info[34].fileLength = 0U;
  c2_info[34].fileTime1 = 0U;
  c2_info[34].fileTime2 = 0U;
  c2_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  ...
  c2_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c2_info[36].name = "plus";
  c2_info[36].dominantType = "double";
  c2_info[36].resolved = "[B]plus";
  c2_info[36].fileLength = 0U;
  c2_info[36].fileTime1 = 0U;
  c2_info[36].fileTime2 = 0U;
  c2_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[37].name = "eml_div";
  c2_info[37].dominantType = "double";
  c2_info[37].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c2_info[37].fileLength = 4254U;
  c2_info[37].fileTime1 = 1192445172U;
  c2_info[37].fileTime2 = 0U;
  c2_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[38].name = "strcmp";
  c2_info[38].dominantType = "char";
  c2_info[38].resolved = "[B]strcmp";
  c2_info[38].fileLength = 0U;
  c2_info[38].fileTime1 = 0U;
  c2_info[38].fileTime2 = 0U;
  c2_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[39].name = "power";
  c2_info[39].dominantType = "double";
  c2_info[39].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[39].fileLength = 4979U;
  c2_info[39].fileTime1 = 1192445320U;
  c2_info[39].fileTime2 = 0U;
  c2_info[40].context = "";
  c2_info[40].name = "minus";
  c2_info[40].dominantType = "double";
  c2_info[40].resolved = "[B]minus";
  c2_info[40].fileLength = 0U;
  c2_info[40].fileTime1 = 0U;
  c2_info[40].fileTime2 = 0U;
  c2_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[41].name = "lt";
  c2_info[41].dominantType = "double";
  c2_info[41].resolved = "[B]lt";
...
/* SFunction Glue Code */
void sf_c2_restart_lv_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_restart_lv_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if (!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_restart_lvMachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_restart_lvMachineNumber_,
            chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_restart_lvMachineNumber_,
            chartInstance.chartNumber,
            0,
            0,
            0);
    ...
    sf_debug_reset_current_state_configuration(_restart_lvMachineNumber_,
      chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c2_restart_lv(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_restart_lv();
  initialize_c2_restart_lv();
}

static void sf_opaque_enable_c2_restart_lv(void *chartInstanceVar)
{
  enable_c2_restart_lv();
}

static void sf_opaque_disable_c2_restart_lv(void *chartInstanceVar)
{
  disable_c2_restart_lv();
}

static void sf_opaque_gateway_c2_restart_lv(void *chartInstanceVar)
{
  sf_c2_restart_lv();
}

static void sf_opaque_terminate_c2_restart_lv(void *chartInstanceVar)
{
  ...
  finalize_c2_restart_lv();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_restart_lv(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_restart_lv(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("restart_lv","restart_lv",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("restart_lv","restart_lv",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("restart_lv","restart_lv",
      2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"restart_lv","restart_lv",2,2);
      sf_mark_chart_reusable_outputs(S,"restart_lv","restart_lv",2,1);
    }

    sf_set_rtw_dwork_info(S,"restart_lv","restart_lv",2);
...
static void mdlRTW_c2_restart_lv(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "restart_lv", "restart_lv",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_restart_lv(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_restart_lv;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_restart_lv;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_restart_lv;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_restart_lv;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_restart_lv;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_restart_lv;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_restart_lv;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_restart_lv;
...
void c2_restart_lv_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_restart_lv(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_restart_lv(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_restart_lv(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_restart_lv_method_dispatcher.\n"
