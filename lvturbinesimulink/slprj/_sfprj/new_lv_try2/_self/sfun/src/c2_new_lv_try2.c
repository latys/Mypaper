...
#include "new_lv_try2_sfun.h"
#include "c2_new_lv_try2.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance.chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance.instanceNumber)
#include "new_lv_try2_sfun_debug_macros.h"
...
static SFc2_new_lv_try2InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_new_lv_try2(void);
static void initialize_params_c2_new_lv_try2(void);
static void enable_c2_new_lv_try2(void);
static void disable_c2_new_lv_try2(void);
static void finalize_c2_new_lv_try2(void);
static void sf_c2_new_lv_try2(void);
...
static void initialize_c2_new_lv_try2(void)
{
  ...
  chartInstance.c2_is_active_c2_new_lv_try2 = 0U;
}
...
static void sf_c2_new_lv_try2(void)
{
  ...
  *c2_b_Te = c2_Te;
  ...
  sf_debug_check_for_state_inconsistency(_new_lv_try2MachineNumber_,
...
const mxArray *sf_c2_new_lv_try2_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[42])
{
  ...
  c2_info[2].fileLength = 376U;
  c2_info[2].fileTime1 = 1192445204U;
  c2_info[2].fileTime2 = 0U;
  c2_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c2_info[3].name = "ischar";
  c2_info[3].dominantType = "char";
  c2_info[3].resolved = "[B]ischar";
  ...
  c2_info[4].name = "isvector";
  c2_info[4].dominantType = "double";
  c2_info[4].resolved = "[B]isvector";
  ...
  c2_info[6].name = "eml_warning";
  c2_info[6].dominantType = "char";
  c2_info[6].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c2_info[6].fileLength = 265U;
  c2_info[6].fileTime1 = 1192445214U;
  ...
  c2_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[8].name = "eml_error";
  c2_info[8].dominantType = "char";
  c2_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c2_info[8].fileLength = 318U;
  c2_info[8].fileTime1 = 1192445176U;
  ...
  c2_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[10].name = "power";
  c2_info[10].dominantType = "double";
  c2_info[10].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[10].fileLength = 4979U;
  c2_info[10].fileTime1 = 1192445320U;
  c2_info[10].fileTime2 = 0U;
  c2_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c2_info[11].name = "logical";
  c2_info[11].dominantType = "double";
  c2_info[11].resolved = "[B]logical";
  ...
  c2_info[13].fileLength = 3338U;
  c2_info[13].fileTime1 = 1192445318U;
  ...
  c2_info[14].fileLength = 638U;
  c2_info[14].fileTime1 = 1197275550U;
  ...
  c2_info[20].name = "double";
  c2_info[20].dominantType = "double";
  c2_info[20].resolved = "[B]double";
  ...
  c2_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[22].name = "eml_alloc";
  c2_info[22].dominantType = "double";
  c2_info[22].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[22].fileLength = 2558U;
  c2_info[22].fileTime1 = 1197275544U;
  ...
  c2_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[25].name = "eml_assert_valid_size_arg";
  c2_info[25].dominantType = "double";
  c2_info[25].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[25].fileLength = 1360U;
  c2_info[25].fileTime1 = 1192445166U;
  ...
  c2_info[28].fileTime1 = 1192445172U;
  ...
  c2_info[29].fileLength = 1990U;
  c2_info[29].fileTime1 = 1197627150U;
  ...
  c2_info[31].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c2_info[31].fileLength = 550U;
  c2_info[31].fileTime1 = 1192445086U;
  c2_info[31].fileTime2 = 0U;
  c2_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[32].name = "rdivide";
  c2_info[32].dominantType = "double";
  c2_info[32].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[32].fileLength = 628U;
  c2_info[32].fileTime1 = 1192445322U;
  ...
  c2_info[35].name = "class";
  c2_info[35].dominantType = "double";
  c2_info[35].resolved = "[B]class";
  ...
  c2_info[36].name = "isreal";
  c2_info[36].dominantType = "double";
  c2_info[36].resolved = "[B]isreal";
  ...
  c2_info[38].resolved = "[B]not";
  c2_info[38].fileLength = 0U;
  c2_info[38].fileTime1 = 0U;
  c2_info[38].fileTime2 = 0U;
  c2_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  ...
  c2_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[40].name = "ndims";
  c2_info[40].dominantType = "double";
  c2_info[40].resolved = "[B]ndims";
...
/* SFunction Glue Code */
void sf_c2_new_lv_try2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_new_lv_try2_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if (!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_new_lv_try2MachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_new_lv_try2MachineNumber_,
            chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_new_lv_try2MachineNumber_,
            chartInstance.chartNumber,
            0,
            0,
            0);
    ...
    sf_debug_reset_current_state_configuration(_new_lv_try2MachineNumber_,
      chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c2_new_lv_try2(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_new_lv_try2();
  initialize_c2_new_lv_try2();
}

static void sf_opaque_enable_c2_new_lv_try2(void *chartInstanceVar)
{
  enable_c2_new_lv_try2();
}

static void sf_opaque_disable_c2_new_lv_try2(void *chartInstanceVar)
{
  disable_c2_new_lv_try2();
}

static void sf_opaque_gateway_c2_new_lv_try2(void *chartInstanceVar)
{
  sf_c2_new_lv_try2();
}

static void sf_opaque_terminate_c2_new_lv_try2(void *chartInstanceVar)
{
  ...
  finalize_c2_new_lv_try2();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_new_lv_try2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_new_lv_try2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("new_lv_try2","new_lv_try2",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("new_lv_try2","new_lv_try2",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("new_lv_try2",
      "new_lv_try2",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"new_lv_try2","new_lv_try2",2,2);
      sf_mark_chart_reusable_outputs(S,"new_lv_try2","new_lv_try2",2,1);
    }

    sf_set_rtw_dwork_info(S,"new_lv_try2","new_lv_try2",2);
...
static void mdlRTW_c2_new_lv_try2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "new_lv_try2", "new_lv_try2",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_new_lv_try2(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_new_lv_try2;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_new_lv_try2;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_new_lv_try2;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_new_lv_try2;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_new_lv_try2;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_new_lv_try2;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_new_lv_try2;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_new_lv_try2;
...
void c2_new_lv_try2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_new_lv_try2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_new_lv_try2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_new_lv_try2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_new_lv_try2_method_dispatcher.\n"
