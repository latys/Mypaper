...
#include "lv_cankao_sfun.h"
#include "c2_lv_cankao.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance.chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance.instanceNumber)
#include "lv_cankao_sfun_debug_macros.h"
...
static SFc2_lv_cankaoInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_lv_cankao(void);
static void initialize_params_c2_lv_cankao(void);
static void enable_c2_lv_cankao(void);
static void disable_c2_lv_cankao(void);
static void finalize_c2_lv_cankao(void);
static void sf_c2_lv_cankao(void);
...
static void initialize_c2_lv_cankao(void)
{
  ...
  chartInstance.c2_is_active_c2_lv_cankao = 0U;
}
...
static void sf_c2_lv_cankao(void)
{
  ...
  *c2_b_Te = c2_Te;
  ...
  sf_debug_check_for_state_inconsistency(_lv_cankaoMachineNumber_,
...
const mxArray *sf_c2_lv_cankao_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[42])
{
  ...
  c2_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[2].fileLength = 4979U;
  c2_info[2].fileTime1 = 1192445320U;
  c2_info[2].fileTime2 = 0U;
  c2_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[3].name = "eml_warning";
  c2_info[3].dominantType = "char";
  c2_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c2_info[3].fileLength = 265U;
  c2_info[3].fileTime1 = 1192445214U;
  c2_info[3].fileTime2 = 0U;
  c2_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[4].name = "eml_assert_valid_size_arg";
  c2_info[4].dominantType = "double";
  c2_info[4].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[4].fileLength = 1360U;
  c2_info[4].fileTime1 = 1192445166U;
  c2_info[4].fileTime2 = 0U;
  c2_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[5].name = "eml_assert";
  c2_info[5].dominantType = "char";
  c2_info[5].resolved = "[B]eml_assert";
  ...
  c2_info[8].name = "double";
  c2_info[8].dominantType = "double";
  c2_info[8].resolved = "[B]double";
  ...
  c2_info[12].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[12].fileLength = 1990U;
  c2_info[12].fileTime1 = 1197627150U;
  ...
  c2_info[16].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[16].name = "isnumeric";
  c2_info[16].dominantType = "double";
  c2_info[16].resolved = "[B]isnumeric";
  ...
  c2_info[18].fileLength = 550U;
  c2_info[18].fileTime1 = 1192445086U;
  c2_info[18].fileTime2 = 0U;
  c2_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[19].name = "class";
  c2_info[19].dominantType = "double";
  c2_info[19].resolved = "[B]class";
  ...
  c2_info[21].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[21].fileLength = 3338U;
  c2_info[21].fileTime1 = 1192445318U;
  c2_info[21].fileTime2 = 0U;
  c2_info[22].context = "";
  c2_info[22].name = "mrdivide";
  c2_info[22].dominantType = "double";
  c2_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[22].fileLength = 638U;
  c2_info[22].fileTime1 = 1197275550U;
  c2_info[22].fileTime2 = 0U;
  c2_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[23].name = "eml_alloc";
  c2_info[23].dominantType = "double";
  c2_info[23].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[23].fileLength = 2558U;
  c2_info[23].fileTime1 = 1197275544U;
  ...
  c2_info[24].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c2_info[24].fileLength = 866U;
  c2_info[24].fileTime1 = 1192445044U;
  ...
  c2_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[26].name = "isstruct";
  c2_info[26].dominantType = "double";
  c2_info[26].resolved = "[B]isstruct";
  ...
  c2_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c2_info[27].fileLength = 237U;
  c2_info[27].fileTime1 = 1192445162U;
  c2_info[27].fileTime2 = 0U;
  c2_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[28].name = "rdivide";
  c2_info[28].dominantType = "double";
  c2_info[28].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[28].fileLength = 628U;
  c2_info[28].fileTime1 = 1192445322U;
  c2_info[28].fileTime2 = 0U;
  c2_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[29].name = "lt";
  ...
  c2_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/assert_integral";
  c2_info[35].name = "false";
  c2_info[35].dominantType = "";
  c2_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c2_info[35].fileLength = 238U;
  c2_info[35].fileTime1 = 1192445120U;
  ...
  c2_info[38].fileTime1 = 1192445172U;
  ...
  c2_info[41].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[41].name = "isvector";
  c2_info[41].dominantType = "double";
  c2_info[41].resolved = "[B]isvector";
...
/* SFunction Glue Code */
void sf_c2_lv_cankao_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_lv_cankao_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if (!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart(_lv_cankaoMachineNumber_,
          2,
          1,
          1,
          3,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_lv_cankaoMachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_lv_cankaoMachineNumber_,
            chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_lv_cankaoMachineNumber_,
            chartInstance.chartNumber,
            0,
            0,
            0);
    ...
    sf_debug_reset_current_state_configuration(_lv_cankaoMachineNumber_,
      chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c2_lv_cankao(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_lv_cankao();
  initialize_c2_lv_cankao();
}

static void sf_opaque_enable_c2_lv_cankao(void *chartInstanceVar)
{
  enable_c2_lv_cankao();
}

static void sf_opaque_disable_c2_lv_cankao(void *chartInstanceVar)
{
  disable_c2_lv_cankao();
}

static void sf_opaque_gateway_c2_lv_cankao(void *chartInstanceVar)
{
  sf_c2_lv_cankao();
}

static void sf_opaque_terminate_c2_lv_cankao(void *chartInstanceVar)
{
  ...
  finalize_c2_lv_cankao();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_lv_cankao(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_lv_cankao(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("lv_cankao","lv_cankao",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("lv_cankao","lv_cankao",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("lv_cankao","lv_cankao",2,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"lv_cankao","lv_cankao",2,2);
      sf_mark_chart_reusable_outputs(S,"lv_cankao","lv_cankao",2,1);
    }

    sf_set_rtw_dwork_info(S,"lv_cankao","lv_cankao",2);
...
static void mdlRTW_c2_lv_cankao(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "lv_cankao", "lv_cankao",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_lv_cankao(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_lv_cankao;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_lv_cankao;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_lv_cankao;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_lv_cankao;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_lv_cankao;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_lv_cankao;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_lv_cankao;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_lv_cankao;
...
void c2_lv_cankao_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_lv_cankao(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_lv_cankao(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_lv_cankao(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_lv_cankao_method_dispatcher.\n"
