...
static SFc2_new_lv_trygenerator_mode1InstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_new_lv_trygenerator_mode1(void);
static void initialize_params_c2_new_lv_trygenerator_mode1(void);
static void enable_c2_new_lv_trygenerator_mode1(void);
static void disable_c2_new_lv_trygenerator_mode1(void);
static void finalize_c2_new_lv_trygenerator_mode1(void);
static void sf_c2_new_lv_trygenerator_mode1(void);
...
static void initialize_c2_new_lv_trygenerator_mode1(void)
{
  ...
  chartInstance.c2_is_active_c2_new_lv_trygenerator_mode1 = 0U;
}
...
const mxArray *sf_c2_new_lv_trygenerator_mode1_get_eml_resolved_functions_info
  (void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[42])
{
  ...
  c2_info[3].name = "ndims";
  c2_info[3].dominantType = "double";
  c2_info[3].resolved = "[B]ndims";
  ...
  c2_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c2_info[6].fileLength = 550U;
  c2_info[6].fileTime1 = 1192445086U;
  c2_info[6].fileTime2 = 0U;
  c2_info[7].context = "";
  c2_info[7].name = "mpower";
  c2_info[7].dominantType = "double";
  c2_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[7].fileLength = 3338U;
  c2_info[7].fileTime1 = 1192445318U;
  ...
  c2_info[12].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[12].fileLength = 638U;
  c2_info[12].fileTime1 = 1197275550U;
  ...
  c2_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c2_info[14].fileLength = 238U;
  c2_info[14].fileTime1 = 1192445120U;
  ...
  c2_info[16].name = "eml_alloc";
  c2_info[16].dominantType = "double";
  c2_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[16].fileLength = 2558U;
  c2_info[16].fileTime1 = 1197275544U;
  ...
  c2_info[19].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/assert_integral";
  c2_info[19].name = "true";
  c2_info[19].dominantType = "";
  c2_info[19].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c2_info[19].fileLength = 237U;
  c2_info[19].fileTime1 = 1192445162U;
  c2_info[19].fileTime2 = 0U;
  c2_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[20].name = "eml_error";
  c2_info[20].dominantType = "char";
  c2_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c2_info[20].fileLength = 318U;
  c2_info[20].fileTime1 = 1192445176U;
  ...
  c2_info[21].fileLength = 866U;
  c2_info[21].fileTime1 = 1192445044U;
  ...
  c2_info[23].name = "eml_scalexp_compatible";
  c2_info[23].dominantType = "double";
  c2_info[23].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c2_info[23].fileLength = 376U;
  c2_info[23].fileTime1 = 1192445204U;
  c2_info[23].fileTime2 = 0U;
  c2_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[24].name = "rdivide";
  c2_info[24].dominantType = "double";
  c2_info[24].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[24].fileLength = 628U;
  c2_info[24].fileTime1 = 1192445322U;
  ...
  c2_info[27].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c2_info[27].name = "double";
  c2_info[27].dominantType = "double";
  c2_info[27].resolved = "[B]double";
  ...
  c2_info[28].fileLength = 1360U;
  c2_info[28].fileTime1 = 1192445166U;
  c2_info[28].fileTime2 = 0U;
  c2_info[29].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[29].name = "isvector";
  c2_info[29].dominantType = "double";
  c2_info[29].resolved = "[B]isvector";
  ...
  c2_info[30].name = "eml_assert";
  c2_info[30].dominantType = "char";
  c2_info[30].resolved = "[B]eml_assert";
  ...
  c2_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  ...
  c2_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[34].name = "eml_warning";
  c2_info[34].dominantType = "char";
  c2_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c2_info[34].fileLength = 265U;
  c2_info[34].fileTime1 = 1192445214U;
  c2_info[34].fileTime2 = 0U;
  c2_info[35].context = "";
  c2_info[35].name = "mtimes";
  c2_info[35].dominantType = "double";
  c2_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[35].fileLength = 1990U;
  c2_info[35].fileTime1 = 1197627150U;
  ...
  c2_info[40].name = "not";
  c2_info[40].dominantType = "logical";
  c2_info[40].resolved = "[B]not";
...
/* SFunction Glue Code */
void sf_c2_new_lv_trygenerator_mode1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_new_lv_trygenerator_mode1_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_new_lv_trygenerator_mode1(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_new_lv_trygenerator_mode1();
  initialize_c2_new_lv_trygenerator_mode1();
}

static void sf_opaque_enable_c2_new_lv_trygenerator_mode1(void *chartInstanceVar)
{
  enable_c2_new_lv_trygenerator_mode1();
}

static void sf_opaque_disable_c2_new_lv_trygenerator_mode1(void
  *chartInstanceVar)
{
  disable_c2_new_lv_trygenerator_mode1();
}

static void sf_opaque_gateway_c2_new_lv_trygenerator_mode1(void
  *chartInstanceVar)
{
  sf_c2_new_lv_trygenerator_mode1();
}

static void sf_opaque_terminate_c2_new_lv_trygenerator_mode1(void
  *chartInstanceVar)
{
  ...
  finalize_c2_new_lv_trygenerator_mode1();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_new_lv_trygenerator_mode1(SimStruct *S)
{
  int i;
...
static void mdlRTW_c2_new_lv_trygenerator_mode1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_new_lv_trygenerator_mode1(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_new_lv_trygenerator_mode1;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_new_lv_trygenerator_mode1;
...
void c2_new_lv_trygenerator_mode1_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_new_lv_trygenerator_mode1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_new_lv_trygenerator_mode1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_new_lv_trygenerator_mode1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_new_lv_trygenerator_mode1_method_dispatcher.\n"
